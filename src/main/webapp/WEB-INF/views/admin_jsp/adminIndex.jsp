			    ...
			    <ul class="catalogo-libri">
			        <c:forEach var="p" items="${prodotti}">
			            <li class="libro">
							...
							<a href="${pageContext.request.contextPath}/Admin/AdminDettaglioProdotto?idLibro=${p.id}" class="form-account btn">Dettaglio  </a>
							
							<a href="${pageContext.request.contextPath}/Admin/AdminModificaProdotto?idLibro=${p.id}" class="form-account btn">Modifica  </a>
							
							<a href="${pageContext.request.contextPath}/Admin/AdminEliminaProdotto?idLibro=${p.id}" class="form-account btn">Elimina</a>
